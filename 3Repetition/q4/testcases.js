module.exports = {
    testcases: [
        ...
        },
        {
            ...
            expected: 3,
            isPublic: false,
            description: 'Negative n should use absolute value: abs(-10) = 10, multiples of 3 = 3',
        },
        {
            input: [12, -4],
            expected: 3,
            isPublic: false,
            description: 'Negative x should use absolute value: abs(-4) = 4, multiples = (4,8,12) = 3',
        },
        {
            input: [-15, -5],
            expected: 3,
            isPublic: false,
            description: 'Both negative should use absolute values: 15, 5 -> (5,10,15) = 3',
        },
        {
            input: [1, 2],
            expected: 0,

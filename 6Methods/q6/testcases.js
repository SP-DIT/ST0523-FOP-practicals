module.exports = {
    testcases: [
        ...
        },
        {
            ...
            commands: [{ method: 'buyItem', params: ['Mana Potion', 4] }],
            expected: [{ value: 'Insufficient stock for Mana Potion', options: {} }],
            isPublic: true,
        ...
        },
        {
            ...
            expected: [
                { value: 45, options: {} },
                { value: [{ name: 'Health Potion', price: 10, quantity: 5 }], options: { type: 'JSON' } },
            ],
            isPublic: true,
        ...
        // Hidden test cases
        {
            input: [[{ name: 'Sword', price: 100, quantity: 2 }]],
            commands: [{ method: 'getAvailableItemList', params: [] }],
            expected: [{ value: [{ name: 'Sword', price: 100, quantity: 2 }], options: { type: 'JSON' } }],
            isPublic: false,
            description: 'Initial available items list',
        },
        {
            input: [[{ name: 'Sword', price: 100, quantity: 1 }]],
            commands: [
        ...
        {
            input: [[{ name: 'Arrow', price: 5, quantity: 20 }]],
            commands: [
        ...
        {
            input: [[{ name: 'Potion', price: 10, quantity: 5 }]],
            commands: [
            ...
            expected: [
                ...
                { value: [{ name: 'Potion', price: 10, quantity: 5 }], options: { type: 'JSON' } },
            ],
            isPublic: false,
        ...
        {
            input: [[{ name: 'Elixir', price: 25, quantity: 10 }]],
            commands: [
            ...
            expected: [
                { value: 75, options: {} },
                { value: 100, options: {} },
                { value: [{ name: 'Elixir', price: 25, quantity: 3 }], options: { type: 'JSON' } },
            ],
            isPublic: false,
            description: 'Multiple purchases: 10 - 3 - 4 = 3 remaining',
        },
        {
            input: [[{ name: 'Staff', price: 150, quantity: 1 }]],
            commands: [{ method: 'buyItem', params: ['Staff', 2] }],
            expected: [{ value: 'Insufficient stock for Staff', options: {} }],
            isPublic: false,
            description: 'Try to buy 2 when only 1 available',
        },
        {
            input: [[{ name: 'Gem', price: 200, quantity: 5 }]],
            commands: [
        ...
        {
            input: [[{ name: 'Scroll', price: 15, quantity: 0 }]],
            commands: [{ method: 'getAvailableItemList', params: [] }],
        ...
        {
            input: [[{ name: 'Ring', price: 75, quantity: 4 }]],
            commands: [
        ...
        },
        {
            ...
            expected: [
                { value: 125, options: {} },
                { value: 70, options: {} },
                { value: [{ name: 'Armor', price: 120, quantity: 3 }], options: { type: 'JSON' } },
            ],
            isPublic: false,
            description: 'Buy all of two items: only one remains available',
        },
        {
            input: [[{ name: 'Wand', price: 60, quantity: 2 }]],
            commands: [
            ...
            expected: [
                { value: 60, options: {} },
                { value: [{ name: 'Wand', price: 60, quantity: 1 }], options: { type: 'JSON' } },
                { value: 60, options: {} },
                { value: [], options: { type: 'JSON' } },
            ],
            isPublic: false,
        ...
        {
            input: [[{ name: 'Torch', price: 5, quantity: 100 }]],
            commands: [
            ...
            expected: [
                { value: 250, options: {} },
                { value: [{ name: 'Torch', price: 5, quantity: 50 }], options: { type: 'JSON' } },
            ],
            isPublic: false,
        ...
        },
        {
            ...
            commands: [{ method: 'buyItem', params: ['InvalidItem', 1] }],
            expected: [{ value: 'Insufficient stock for InvalidItem', options: {} }],
            isPublic: false,
        ...
        },
        {
            ...
            expected: [
                { value: 200, options: {} },
                { value: 200, options: {} },
                { value: [{ name: 'Shield', price: 100, quantity: 1 }], options: { type: 'JSON' } },

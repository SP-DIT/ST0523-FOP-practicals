...
-   [0. Debugging Your Code](#0-debugging-your-code)
    -   [0.1. Method 1: Manual Testing with Example Inputs](#01-method-1-manual-testing-with-example-inputs)
    -   [0.2. Method 2: Automated Testing with Test Cases](#02-method-2-automated-testing-with-test-cases)
        -   [0.2.1 Understanding Test Output](#021-understanding-test-output)
-   [1. Data Types](#1-data-types)
    -   [1.1 Numbers](#11-numbers)
        -   [1.1.1 Numerical Operators](#111-numerical-operators)
    -   [1.2 Strings](#12-strings)
        -   [1.2.1 String Operator](#121-string-operator)
    -   [1.3 Boolean](#13-boolean)
        -   [1.3.1 Comparison Operators](#131-comparison-operators)
        -   [1.3.2 Boolean Logical Operators](#132-boolean-logical-operators)
    -   [1.4 Syntax Errors](#14-syntax-errors)
    -   [1.5 Substitution Model](#15-substitution-model)
        -   [1.5.1 Precedence](#151-precedence)
        -   [1.5.2 Associativity](#152-associativity)
        -   [1.5.3 Precedence Table](#153-precedence-table)
-   [2. Variables](#2-variables)
    -   [2.1 Variable Declaration](#21-variable-declaration)
    -   [2.2 Assignment Operator](#22-assignment-operator)
        -   [2.2.1 Error with Modifying `const` Variables](#221-error-with-modifying-const-variables)
    -   [2.3 Identifiers (Variable Names)](#23-identifiers-variable-names)
-   [3. Functions](#3-functions)
    -   [3.1 Function Declaration](#31-function-declaration)
    -   [3.2 Function Call (Application)](#32-function-call-application)
        -   [3.2.1 ReferenceError](#321-referenceerror)
        -   [3.2.2 TypeError](#322-typeerror)
-   [4. Conditional Statements (if-else)](#4-conditional-statements-if-else)
    -   [4.1 Basic if-else Statement](#41-basic-if-else-statement)
    -   [4.2 else if (Multiple Conditions)](#42-else-if-multiple-conditions)
    -   [4.3 Nested if Statements](#43-nested-if-statements)
-   [5. For Loops](#5-for-loops)
    -   [5.1 Basic for Loop Syntax](#51-basic-for-loop-syntax)
    -   [5.2 Loop Execution Flow](#52-loop-execution-flow)
    -   [5.3 Accumulator pattern](#53-accumulator-pattern)
        -   [5.3.1 Sum from 1-to-n](#531-sum-from-1-to-n)
        -   [5.3.2 Product from 1-to-n](#532-product-from-1-to-n)
        -   [5.3.3 Count even number from 1-to-n](#533-count-even-number-from-1-to-n)
        -   [5.3.4 Fibonacci number](#534-fibonacci-number)
    -   [5.4 Common Loop Errors](#54-common-loop-errors)
        -   [5.4.1 Infinite Loops](#541-infinite-loops)
        -   [5.4.2 Off-by-One Errors](#542-off-by-one-errors)
        -   [5.4.3 Variable Scope Error](#543-variable-scope-error)
-   [6. Objects](#6-objects)
    -   [6.1 Object Creation](#61-object-creation)
    -   [6.2 Property Access](#62-property-access)
        -   [Dot Notation](#dot-notation)
        -   [Square Bracket Notation](#square-bracket-notation)
    -   [6.3 Common Property Access Errors](#63-common-property-access-errors)
        -   [6.3.1 Accessing Non-existent Properties](#631-accessing-non-existent-properties)
        -   [6.3.2 Mixing Dot and Bracket Notation Syntax](#632-mixing-dot-and-bracket-notation-syntax)
        -   [6.3.3 Accessing Properties of undefined](#633-accessing-properties-of-undefined)
    -   [6.4 Modifying Object Properties](#64-modifying-object-properties)
    -   [6.5 Methods (Functions in Objects)](#65-methods-functions-in-objects)
        -   [6.5.1 The `this` Keyword](#651-the-this-keyword)
    -   [6.6 Pass by Reference](#66-pass-by-reference)
-   [7. Arrays](#7-arrays)
    -   [7.1 Array Creation](#71-array-creation)
    -   [7.2 Array Element Access](#72-array-element-access)
        -   [7.2.1 Accessing Non-existent Indices](#721-accessing-non-existent-indices)
    -   [7.3 Modifying Arrays](#73-modifying-arrays)
        -   [Adding Elements](#adding-elements)
        -   [Updating Elements](#updating-elements)
    -   [7.4 Array Length](#74-array-length)
    -   [7.5 Standard for-loop to iterate through the whole array](#75-standard-for-loop-to-iterate-through-the-whole-array)
        -   [7.5.1 Front-to-back](#751-front-to-back)
        -   [7.5.2 Back-to-front](#752-back-to-front)
    -   [7.6 Common Array Manipulation](#76-common-array-manipulation)
        -   [7.6.1 Accumulating](#761-accumulating)
        -   [7.6.2 Mapping](#762-mapping)
        -   [7.6.3 Filtering](#763-filtering)
-   [8. Wishful Thinking](#8-wishful-thinking)
    -   [8.1 The Wishful Thinking Process](#81-the-wishful-thinking-process)
    -   [8.2 Example 1: Computing the Area of a Circle](#82-example-1-computing-the-area-of-a-circle)
    -   [8.3 Example 2: Grade Calculator](#83-example-2-grade-calculator)
    -   [8.4 Example 3: Array Processing](#84-example-3-array-processing)
    -   [8.5 Example 4: Complex Object Processing](#85-example-4-complex-object-processing)
    -   [8.6 Benefits of Wishful Thinking](#86-benefits-of-wishful-thinking)
    -   [8.7 When to Use Wishful Thinking](#87-when-to-use-wishful-thinking)
